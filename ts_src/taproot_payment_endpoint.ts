...
export class TaprootPaymentEndpoint {
    ...
    tapRoot: string;
    tapBranch: string; //temp, this will likely be an Array
    tapTweak: string;
    ...
    createTapBranch() { //asuming there is only 2 leaves. This will change //to do: function that creates the merkle tree
        const tapLeafs = [];
    ...
    createTapRoot() { //asuming there is only 2 leaves. This will change //to do: function that creates the merkle tree
