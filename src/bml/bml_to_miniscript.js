...
export function getMinisciptFragment(bmlType) {
    return BmlTypeToMiniscript[bmlType];
}
export function generateOneHopMinisciptFragments(bmlArray) {
    let resultantArray = [];
...
function getNextInSequence(elementsArray, fromElementId) {
